    ...
    def _init_skill_patterns(self) -> Dict[SkillType, List[str]]:
        ...
        return {
            SkillType.PROCESS: [
                ...
                r'发票', r'材料', r'申请', r'办理', r'流程', r'步骤', r'手续',
                r'转诊', r'急诊', r'寒暑假', r'到账', r'周期', r'截止',
                
                # 办事流程
                r'申请', r'办理', r'手续', r'流程', r'步骤', r'怎么', r'如何',
                r'需要', r'要求', r'材料', r'证明', r'盖章', r'审核',
                
                # 学籍管理
                r'学籍', r'注册', r'休学', r'复学', r'转学', r'退学',
                
                # 宿舍申请
                r'宿舍', r'住宿', r'申请', r'调换', r'退宿',
                
                # 证明开具
                r'证明', r'成绩单', r'在读证明', r'毕业证明', r'学位证明'
            ],
